...
function initCursor() {
  ...
  const hoverTargets = document.querySelectorAll('a, button, .card, .feature-card, .lens-card, .faq-item, .social-link, .pin, .hamburger');
...
/* ============================================
   5. SUNCALC — GOLDEN HOUR HESAPLAMA
   ============================================ */
...
/* ============================================
   9. SAYFA BAZLI INIT (TÜM TETİKLEYİCİLER BURADA)
   ============================================ */
